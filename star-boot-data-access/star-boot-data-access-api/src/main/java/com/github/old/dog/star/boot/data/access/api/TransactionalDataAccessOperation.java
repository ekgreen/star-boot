...
/**
 * Represents an interface that defines a Data-Access-based transactional operation.
 * This interface extends the {@link DataAccessOperation} interface with specific
 ...
 */
public interface TransactionalDataAccessOperation extends DataAccessOperation<Void, Void> {
     ...
     * delegating the execution to the DataAccessOperation's default implementation of
    ...
    default Void doThrowableOperation(Void repo) {
        return DataAccessOperation.super.doThrowableOperation(repo);
    }
}
